...
const Privacy: React.FC = () => {
  return (
    <>
      ...
      <p></p>
      <p>
        This Privacy Policy describes Our <strong>policies</strong> and
        <strong> procedures</strong> on the collection, use and
        <strong> disclosure</strong> of Your information when You use the
        ...
        by the Privacy Policy Generator.
      </p>
      <p></p>
      ...
      <p>
        ...
        <ul style={{ paddingLeft: "1.5em" }}>
          ...
          <li>
            ...
            this Agreement) refers to cheffy.
          </li>
        ...
        use the Service. Personal Data is any information that relates to an
      ...
      <p>
        ...
        browsing history on that website among its many uses. Device means any
        ...
        example, the duration of a page visit). Collecting and Using Your
        Personal Data.
      </p>
      ...
      <p>
        ...
        may not be able to use some parts of our Service. <br />
        ‣ Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies
        remain on your personal computer or mobile device when You go offline,
        while Session Cookies are deleted as soon as You close your web browser.
        Learn more about cookies in the "What Are Cookies" article. <br />
        <br />
        ...
        <p>
          ...
          Cookies to provide You with those services. <br />
          Cookies Policy / Notice Acceptance Cookies <br />
          <br />‣ Type: Persistent Cookies <br /> Administered by: US
          <br /> Purpose: These Cookies identify if users have accepted the use
          of cookies on the Website.
          <br /> Functionality Cookies <br />
          <br />‣ Type: Persistent Cookies
          <br /> Administered by: US
          <br /> Purpose: These Cookies allow us to remember choices You make
          ...
          visit our <strong>Cookies Policy</strong>.
        </p>
      </p>
      <p></p>
      ...
      <ul style={{ paddingLeft: "1.5em" }}>
        ...
        <li>
          usiness transfers: We may share or transfer Your personal information
      ...
      <p>
        ...
        legal agreements and policies. <br />‣ The Company will also retain
      ...
      <p>
        ...
        <a href="https://www.thecheffy.com/contact.html">
          https://www.thecheffy.com
        </a>
      </p>
    </>
  );
